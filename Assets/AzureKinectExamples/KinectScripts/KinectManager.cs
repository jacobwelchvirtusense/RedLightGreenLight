...
namespace com.rfilkov.kinect
{
    ...
    public class KinectManager : MonoBehaviour
    {
        ...
        [Range(0.0f, 5.0f)]
        [Tooltip("The percentage of the screen width to place the sensor data")]
        [SerializeField] private float displayedImageXPos = 0.76f;

        [Range(0.0f, 5.0f)]
        [Tooltip("The percentage of the screen height to place the sensor data")]
        [SerializeField] private float displayedImageYPos = 1.0f;

        [Tooltip("The background color for the sensor data image")]
        [SerializeField] private Color displayedImageBackgroundColor = Color.black;

        public bool shouldDisplaySensorData = true;

        public void EnableSensorDisplayData(bool shouldEnable)
        {
            shouldDisplaySensorData = shouldEnable;
        }
        ...
        public Color[] GetBodyIndexColors()
        {
            ...
            for (int i = 0; i < numUserIndices; i++)
            {
                ...
                {
                    clrUsers[i] = Color.yellow;  // _bodyIndexColors[i % _bodyIndexColors.Length];
                }
            }
...
//            }
        ...
        void OnGUI()
        {
            ...
            for (int i = 0; i < displayImages.Count; i++)
            {
                ...
                if(imageTex != null && shouldDisplaySensorData)
                {
                    KinectInterop.DisplayGuiTexture(i, displayImageWidthPercent, imageScale, imageTex, displayedImageXPos, displayedImageYPos, displayedImageBackgroundColor);
                }
            }
        }
