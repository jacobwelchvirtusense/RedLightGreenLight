...
//            public Vector2[] color2DepthFrame = null;
        ...
        public static void DisplayGuiTexture(int displayIndex, float screenWidthPercent, Vector2 imageScale, Texture imageTex, float posX, float posY, Color backgroundColor)
        {
            ...
            rectY = Screen.height*posY;
            //if (rectHeight < 0) rectY -= rectHeight*2;
            rectX = Screen.width * posX;
